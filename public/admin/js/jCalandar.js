...
(function($) {
    $.fn.jalendar = function(options) {
        ...
        dayNames.EN = new Array("월", "화", "수", "목", "금", "토", "일");

        monthNames.EN = new Array("1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월");
        ...
        $this.append($('<input type="hidden" class="data1" /><input type="hidden" class="data2" />'), div("div", "jalendar-container").append(div("div", "jalendar-pages").append(div("div", "header").append(div("a", "prv-m"), div("h1"), div("a", "nxt-m"), div("div", "day-names")), div("div", "days"), div("div", "add-event").append(div("div", "events").append(div("h3", "").html("<span></span> " + lEvent[settings.lang]), div("div", "events-list")), div("div", "close-button").text(lClose[settings.lang])))));
        ...
        function calcMonth() {
            ...
            $this.find(".header h1").html(year + " " + monthNames[settings.lang][month] + '<div class="total-bar"></div>');
            ...
            if (month == d.getMonth() && year == d.getFullYear() ) {
                $this.find(".day.this-month").removeClass("selected").eq(date - 1).addClass("selected");
            } else {
                $this.find(".day.this-month").removeClass("selected").attr("style", "");
            }
            var today = new Date();
            if (month == today.getMonth() && year == today.getFullYear() ) {
                $this.find(".day.this-month").removeClass("today").eq(today.getDate() - 1).addClass("today");
            } else {
